...
//               <Link href="#" className="text-2xl bg-gradient-to-r from-black via-mid to-light bg-clip-text text-transparent font-bold ">
//                 Doculus
//               </Link>
//             </div>
//             <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
//               <Link href="/home" className="text-black inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-gray-300">
//                 Home
//               </Link>
//               <Link href="/departments?type=uni" className="text-black inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-gray-300">
//                 Department
//               </Link>
//               <Link href="/departments?type=admin" className="text-black inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-gray-300">
//                 Admin
//               </Link>
//               <Link href="/tutorial" className="text-black inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-gray-300">
//                 Tutorial
//               </Link>
//               <Link href="/about" className="text-black inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-gray-300">
//                 About
//               </Link>
//             </div>
//           </div>
