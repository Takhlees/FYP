        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:items-center">
              ...
              <button
                onClick={toggleTheme}
                className="p-2 mr-4 rounded-full dark:hover:bg-gray-700 focus:outline-none"
                aria-label="Toggle dark mode"
              >
                {theme === "light" ? (
                  <Moon className="w-6 h-6" style={{ color: "var(--icon-color)" }} />
                ) : (
                  <Sun className="w-6 h-6" style={{ color: "var(--icon-color)" }} />
                )}
              </button>
